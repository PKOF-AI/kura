...
SQLMODEL_AVAILABLE = importlib.util.find_spec("sqlmodel") is not None
...
if SQLMODEL_AVAILABLE:
    from .sql import SQLCheckpointManager as SQLCheckpointManager
    __all__.append("SQLCheckpointManager")
